        ...
        ModuleSchema {
            ...
            options: vec![
                ...
                WaybarOption {
                    ...
                    option_type: OptionType::String,
                    default: "{essid} ({signalStrength}%) ".into(),
        ...
        ModuleSchema {
            ...
            options: vec![
                ...
                WaybarOption {
                    name: "format-icons".into(),
                    option_type: OptionType::Json,
                    default: "{\"activated\": \"\", \"deactivated\": \"\"}".into(),
                    description: "Icons".into(),
                    choices: None,
                    min: None,
                    max: None,
